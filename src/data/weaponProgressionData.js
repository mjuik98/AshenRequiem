export const weaponProgressionData = {
  ...
  holy_bolt: [
    { level: 2, damageDelta: 1, cooldownMult: 0.93, description: '홀리 볼트 데미지 +1, 쿨다운 7% 감소' },
    { level: 3, cooldownMult: 0.93, description: '홀리 볼트 쿨다운 7% 감소' },
    { level: 4, damageDelta: 1, cooldownMult: 0.93, description: '홀리 볼트 데미지 +1, 쿨다운 7% 감소' },
    { level: 5, projectileCountDelta: 1, description: '홀리 볼트 동시 발사 +1' },
    { level: 6, damageDelta: 1, cooldownMult: 0.90, description: '홀리 볼트 데미지 +1, 쿨다운 10% 감소' },
    { level: 7, projectileCountDelta: 1, description: '홀리 볼트 동시 발사 +1' },
  ],
  ice_bolt: [
    { level: 2, damageDelta: 1, description: '아이스 볼트 데미지 +1' },
    { level: 3, cooldownMult: 0.94, description: '아이스 볼트 쿨다운 6% 감소' },
    { level: 4, damageDelta: 1, description: '아이스 볼트 데미지 +1' },
    { level: 5, pierceDelta: 1, description: '아이스 볼트 관통 +1' },
    { level: 6, damageDelta: 2, description: '아이스 볼트 데미지 +2' },
    { level: 7, projectileCountDelta: 1, description: '아이스 볼트 동시 발사 +1' },
  ],
  holy_aura: [
  ...
  holy_bolt_upgrade: [
    { level: 2, damageDelta: 1, cooldownMult: 0.94, description: '홀리 볼트 업그레이드 데미지 +1, 쿨다운 6% 감소' },
    { level: 3, projectileCountDelta: 1, description: '홀리 볼트 업그레이드 동시 발사 +1' },
    { level: 4, damageDelta: 1, cooldownMult: 0.94, description: '홀리 볼트 업그레이드 데미지 +1, 쿨다운 6% 감소' },
    { level: 5, cooldownMult: 0.92, description: '홀리 볼트 업그레이드 쿨다운 8% 감소' },
    { level: 6, damageDelta: 2, cooldownMult: 0.90, description: '홀리 볼트 업그레이드 데미지 +2, 쿨다운 10% 감소' },
    { level: 7, projectileCountDelta: 1, description: '홀리 볼트 업그레이드 동시 발사 +1' },
  ],
  ice_bolt_upgrade: [
    { level: 2, damageDelta: 2, description: '아이스 볼트 업그레이드 데미지 +2' },
    { level: 3, pierceDelta: 1, description: '아이스 볼트 업그레이드 관통 +1' },
    { level: 4, damageDelta: 2, description: '아이스 볼트 업그레이드 데미지 +2' },
    { level: 5, cooldownMult: 0.92, description: '아이스 볼트 업그레이드 쿨다운 8% 감소' },
    { level: 6, damageDelta: 3, description: '아이스 볼트 업그레이드 데미지 +3' },
    { level: 7, projectileCountDelta: 1, description: '아이스 볼트 업그레이드 동시 발사 +1' },
  ],
  storm_crown: [
