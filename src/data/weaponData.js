...
export const weaponData = [
  ...
  },
  {
    ...
    damage: 4, cooldown: 1.5, range: 320, radius: 14,
    beamLength: 240, beamSegments: 4, beamLifetime: 0.12,
  ...
  },
  {
    ...
    damage: 10, cooldown: 1.1, projectileSpeed: 420, range: 520,
    radius: 7, pierce: 3, spread: 0, projectileColor: '#d4a373',
    projectileCount: 1,
    behaviorId: 'targetProjectile', maxLevel: 7,
  },
  {
    ...
    damage: 3, cooldown: 1.6, range: 280, radius: 40,
    zoneDuration: 1.8, zoneTickInterval: 0.35,
  ...
  },
  {
    ...
    damage: 2, cooldown: 1.8, range: 260, radius: 46,
    zoneDuration: 2.2, zoneTickInterval: 0.4,
  ...
  },
  {
    ...
    damage: 6, cooldown: 1.2, projectileSpeed: 320, range: 360,
  ...
  },
  {
    ...
    damage: 5, cooldown: 1.0, projectileSpeed: 300, range: 340,
    radius: 8, pierce: 3, bounceCount: 2, projectileColor: '#fff3b0',
    projectileCount: 1,
    behaviorId: 'ricochetProjectile', maxLevel: 7,
  },
