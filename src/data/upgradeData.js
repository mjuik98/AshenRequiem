...
export const upgradeData = [
  ...
  // ── 무기 강화 ────────────────────────────────────────────────
  { id: 'up_magic_bolt',     type: 'weapon_upgrade', weaponId: 'magic_bolt',    name: 'Magic Bolt +',  description: '마법탄 데미지 +1, 쿨다운 감소' },
  { id: 'up_holy_aura',      type: 'weapon_upgrade', weaponId: 'holy_aura',     name: 'Holy Aura +',   description: '오라 데미지 +1, 범위 확대' },
  { id: 'up_lightning_ring', type: 'weapon_upgrade', weaponId: 'lightning_ring',name: 'Lightning Ring +', description: '전기 구체 데미지 +1' },
  { id: 'up_frost_nova',     type: 'weapon_upgrade', weaponId: 'frost_nova',    name: 'Frost Nova +',  description: '냉기 폭발 데미지 +2' },
  { id: 'up_boomerang',      type: 'weapon_upgrade', weaponId: 'boomerang',     name: 'Boomerang +',   description: '부메랑 데미지 +1, 관통 +1' },
