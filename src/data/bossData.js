    ...
    phases: [
      {
        ...
        phaseActions: [
          { type: 'reposition', distance: 180, angleOffset: 0, burstColor: '#ffd180' },
          { type: 'stage_echo' },
        ],
      },
      {
        ...
        phaseActions: [
          { type: 'heal_pulse', healRatio: 0.15, color: '#b8ffd5', radius: 34 },
          { type: 'stage_echo' },
        ],
      },
    ],
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        ...
        phaseAction: { type: 'burst', count: 6, color: '#ff8a65', radius: 26, duration: 0.8 },
        phaseActions: [
          { type: 'burst', count: 6, color: '#ff8a65', radius: 26, duration: 0.8 },
          { type: 'stage_echo' },
        ],
      },
    ],
    ...
    phases: [
      {
        ...
        phaseActions: [
          { type: 'projectile_arc', count: 5, spreadAngle: 0.9, speedMult: 1.1, damageMult: 1.1, color: '#fff4a3' },
          { type: 'stage_echo' },
        ],
      },
      {
        ...
        phaseAction: { type: 'reposition', distance: 140, angleOffset: 0, burstColor: '#fff1a4' },
        phaseActions: [
          { type: 'reposition', distance: 140, angleOffset: 0, burstColor: '#fff1a4' },
          { type: 'stage_echo' },
        ],
      },
    ],
    ...
    phases: [
      {
        ...
        phaseActions: [
          { type: 'projectile_nova', count: 6, speedMult: 1.05, damageMult: 1.05, color: '#8ddfff' },
          { type: 'stage_echo' },
        ],
      },
      {
        ...
        phaseAction: { type: 'projectile_barrage', count: 10, speedMult: 1.15, damageMult: 1.15, color: '#7ce7ff', maxRange: 620 },
        phaseActions: [
          { type: 'projectile_barrage', count: 10, speedMult: 1.15, damageMult: 1.15, color: '#7ce7ff', maxRange: 620 },
          { type: 'stage_echo' },
        ],
      },
    ],
