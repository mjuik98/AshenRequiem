...
export const PAUSE_VIEW_CSS = `
  ...
  .pv-loadout-power-row, .pv-loadout-link-row, .pv-loadout-synergy-head, .pv-loadout-evolution-head { display: flex; align-items: center; justify-content: space-between; gap: 12px; }
  ...
  .pv-loadout-synergy-row, .pv-loadout-evolution-row { padding: 10px 12px; border-radius: 12px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.07); }
  .pv-loadout-synergy-row.active, .pv-loadout-evolution-row.done { border-color: rgba(212,175,106,0.28); background: rgba(212,175,106,0.08); }
