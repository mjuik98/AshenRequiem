export function renderSettingsAudioIcon() {
...
export function renderSettingsGraphicsIcon() {
  return `<svg width="14" height="14" viewBox="0 0 16 16" fill="none" style="display:block">
...
export function renderSettingsDisplayIcon() {
  return `<svg width="14" height="14" viewBox="0 0 16 16" fill="none" style="display:block">
...
export function renderSettingsControlsIcon() {
  return `<svg width="14" height="14" viewBox="0 0 16 16" fill="none" style="display:block">
